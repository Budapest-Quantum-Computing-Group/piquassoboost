...
*/
void IterateOverSelectedModes( const PicVector<char>& selected_modes, int mode_to_iterate, matrix &L, const size_t reuse_index, tbb::combinable<long double>& priv_addend, tbb::task_group &tg );
