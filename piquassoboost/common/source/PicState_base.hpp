...
#ifndef PICSTATE_BASE_HPP
#define PICSTATE_BASE_HPP
...
*/
PicState_base() : matrix_base<intType>() {
    this->rows = 1;
    this->cols = 0;
}
...
@return Returns with the instance of the class.
*/
PicState_base( intType* data_in, size_t cols_in) : matrix_base<intType>(data_in, 1, cols_in) {
...
@return Returns with the instance of the class.
*/
PicState_base( size_t cols_in) : matrix_base<intType>(1, cols_in) {
...
@return Returns with the instance of the class.
*/
PicState_base( size_t cols_in, intType value) : matrix_base<intType>(1, cols_in) {
...
*/
PicState_base(const PicState_base &in) : matrix_base<intType>(in) {
...
*/
bool
operator==( const PicState_base &state) const {
...
*/
void
operator= (const PicState_base &state ) {
...
copy() const {
     ...
     PicState_base ret = PicState_base(this->cols);
...
filter(std::function<bool(intType)> func){
    ...
    PicState_base new_state(numberOfElements);
