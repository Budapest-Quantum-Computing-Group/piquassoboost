...
*/
n_aryGrayCodeCounter::n_aryGrayCodeCounter( PicState_int& n_ary_limits_in) {
...
*/
n_aryGrayCodeCounter::n_aryGrayCodeCounter( PicState_int& n_ary_limits_in, int64_t initial_offset) {
...
n_aryGrayCodeCounter::initialize( int64_t initial_offset ) {
    ...
    counter_chain = PicState_int( n_ary_limits.size() );
