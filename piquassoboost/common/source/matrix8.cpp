...
*/
matrix8::matrix8() : matrix_base<Complex8>() {
...
@return Returns with the instance of the class.
*/
matrix8::matrix8( Complex8* data_in, size_t rows_in, size_t cols_in) : matrix_base<Complex8>(data_in, rows_in, cols_in) {
...
@return Returns with the instance of the class.
*/
matrix8::matrix8( Complex8* data_in, size_t rows_in, size_t cols_in, size_t stride_in) : matrix_base<Complex8>(data_in, rows_in, cols_in, stride_in) {
...
@return Returns with the instance of the class.
*/
matrix8::matrix8( size_t rows_in, size_t cols_in) : matrix_base<Complex8>(rows_in, cols_in) {
...
@return Returns with the instance of the class.
*/
matrix8::matrix8( size_t rows_in, size_t cols_in, size_t stride_in) : matrix_base<Complex8>(rows_in, cols_in, stride_in) {
...
*/
matrix8::matrix8(const matrix8 &in) : matrix_base<Complex8>(in) {
...
matrix8::copy() {
  ...
  matrix8 ret = matrix8(rows, cols, stride);
  ...
  memcpy( ret.data, data, rows*cols*sizeof(Complex8));
