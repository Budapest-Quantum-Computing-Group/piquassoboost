...
/** Python interface method for calculating the permanent of a matrix based on
 *  pic::GlynnPermanentCalculatorRepeatedFloat
 */
static PyObject *
permanent_CPU_repeated_float(PyObject *self, PyObject *args, PyObject *kwds)
{
    // The tuple of expected keywords
    static char *kwlist[] = {(char*)"matrix", (char*)"input_state", (char*)"output_state", NULL};
    ...
    pic::GlynnPermanentCalculatorRepeatedFloat calculator = pic::GlynnPermanentCalculatorRepeatedFloat();
...
static PyMethodDef permanent_calculators_functions[] = {
    {
        ...
        (PyCFunction)(void(*)(void)) permanent_CPU_repeated_float,
        METH_VARARGS | METH_KEYWORDS,
        "Calculate the permanent of the parameter matrix with float precision."
    },
    {
