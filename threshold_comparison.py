...
from thewalrus.quantum import mean_clicks
from gbs.MIS_click import ClickMIS
...
def _run_pq_simulation(params, d) -> float:
    ...
    pq_program.execute(shots=SHOTS)
