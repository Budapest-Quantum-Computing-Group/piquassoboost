...
*/
matrix Omega(int varalpha, int varbeta, Complex16 x, Complex16 y );
...
*/
matrix M( int varalpha, int varbeta, Complex16 s, Complex16 t );
...
*/
matrix Q(  Complex16 u1, Complex16 u2 );
